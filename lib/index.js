...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.pagePrint = factory(global.html2canvas));
   ...
   * 获取浏览器 x 轴滚动条高度
   */
  var getScrollbarHeight = function getScrollbarHeight() {
  ...
  var generateDiv = function generateDiv() {
    var div = document.createElement('div');
    var style = {
      position: 'fixed',
      top: '0px',
  ...
  var generateIframe = function generateIframe() {
  ...
  var humpToHyphen = function humpToHyphen(val) {
    var reg = /[A-Z]/g;
    return val.replace(reg, function (match) {
      return '-' + match.toLowerCase();
    });
  };
  var generateStyleSheet = function generateStyleSheet(styleObj) {
    ...
    for (var selector in styleObj) {
      ...
      for (var prop in styleObj[selector]) {
        ruleArr.push("".concat(humpToHyphen(prop), ": ").concat(styleObj[selector][prop]));
      }

      innerHTML += "".concat(selector, " { ").concat(ruleArr.join('; '), " } ");
    }
  ...
  var PagePrint = /*#__PURE__*/function () {
    function PagePrint() {
    ...
    _createClass(PagePrint, [{
      key: "setWrap",
      value: function () {
        var _setWrap = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
          var target, _this$column, width, height, style, key;
              ...
              switch (_context.prev = _context.next) {
                ...
                case 4:
                  ...
                  style = {
                    ...
                    columns: "".concat(width, "px auto")
                  };

                  for (key in style) {
                    this.wrap.style[key] = style[key];
                  }
        ...
        function setWrap() {
          return _setWrap.apply(this, arguments);
        }
      ...
      value: function setIframe() {
        var _ifr$contentDocument;

        var _this$column2 = this.column,
            width = _this$column2.width,
        ...
        var styleSheet = generateStyleSheet(styleObj);
        (_ifr$contentDocument = ifr.contentDocument) === null || _ifr$contentDocument === void 0 ? void 0 : _ifr$contentDocument.head.appendChild(styleSheet);
        ifr.style.width = "".concat(width + this.scrollbarHeight, "px");
        ifr.style.height = "".concat(height, "px");
        this.iframe = ifr;
      }
    }, {
      key: "shot",
      value: function () {
        var _shot = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
          var column, _this$opts2, wrapHandler, ratio, el, content, columnCount, canvasList, currentIndex, opts, offset, canvas;

          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  column = this.column, _this$opts2 = this.opts, wrapHandler = _this$opts2.wrapHandler, ratio = _this$opts2.ratio;
                  el = wrapHandler ? wrapHandler(this.wrap) : this.wrap;
                  content = {
                    width: el.scrollWidth,
                    height: el.scrollHeight
                  };
                  columnCount = Math.floor(content.width / column.width);
                  canvasList = [];
                  currentIndex = 0;
                  opts = {
                    allowTaint: true,
                    ...
                    windowHeight: content.height + this.scrollbarHeight,
                    scrollX: 0,
                    scrollY: 0,
                    scale: window.devicePixelRatio * ratio,
                ...
                case 7:
                  ...
                  offset = (currentIndex - 1) * column.width;
                  el.scrollLeft = offset;
                  _context2.next = 12;
                  return html2canvas__default['default'](el, opts);
                ...
                case 16:
                  return _context2.abrupt("return", canvasList);
  ...
  PagePrint.printTypeList = ['A1', 'A2', 'A3', 'A4', 'A5'];
  PagePrint.printTypeMap = new Map([['A1', {
    width: 1685,
    height: 2384
  }], ['A2', {
    width: 1190,
  ...
  var singleton = function singleton(opts) {
    ...
    instance.opts = opts;
    instance.column = PagePrint.printTypeMap.get(opts.type);
